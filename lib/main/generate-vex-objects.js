      ...
      barRegion.contents.forEach((obj, objIndex) => {
        ...
        if (!obj.rest) {
          ...
          const tabNoteToAdd = new TabNote({
            ...
            duration,
            stem_direction: -1
          }, renderOptions.tabStemsVisibility);
          if (isDotted) { tabNoteToAdd.addDot(); } // do double dotted notes work?
          ...
          if (obj.gracenotes) {
            ...
            obj.gracenotes.forEach((graceNote) => {
              ...
              const graceNoteToAdd = new GraceTabNote({
                positions: getTabPosition([graceKey], currentAbcKeySignature, barRegion.contents, objIndex, renderOptions.tuning, true),
