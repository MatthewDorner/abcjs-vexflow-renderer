...
export default function getTune(abcString, renderOptions) {
  ...
  // there is another method in abcjs, the regular render method can be used if you pass in "*" for the HTML element,
  // and the resulting object will have more info than if you use parseOnly? I haven't tried this.
