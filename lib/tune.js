...
export default class AbcjsVexFlowParser {
  constructor(abcString, renderOptions) {
    ...
    // console.log('abckeysignature was: ');
    // console.log(this.tuneAttrs.abcKeySignature);
    ...
    partRegions.forEach((partRegion, partIndex) => {
      ...
      partRegion.barRegions.forEach((barRegion, barIndex) => {
        ...
        barRegion.contents.forEach((obj, objIndex) => {
          ...
          // console.log('a tabnote: ');
          // console.log(JSON.stringify((tabNoteToAdd)));
