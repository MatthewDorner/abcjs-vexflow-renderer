...
export default {
  ...
  */
  ...
  /*
        ...
        unless they have a natural accidental)
  ...
  */
  getTabPosition(keys, abcKeySignature, barContents, i) {
    ...
    // accidental later that overrides the first accidental for the same noot?.. it outhgt
    // to since it starts at the beginning ... it would take the first one but then be
    // rewritten by the second one, a test case to implement though.
